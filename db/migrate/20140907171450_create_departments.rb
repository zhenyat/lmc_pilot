...
class CreateDepartments < ActiveRecord::Migration
  def change
    ...
    Department.create number: '00', title: 'Дирекция магазина'
    ...
    Department.create number: '06', title: 'Настенная и напольная плитка'
    ...
    Department.create number: '97', title: 'Гости'
    Department.create number: '98', title: 'Тестирование'
    Department.create number: '99', title: 'Администраторы системы'
  end
end
